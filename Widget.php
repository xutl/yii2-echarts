...
class Widget extends \yii\base\Widget
{
    ...
    /**
     * @var array the options for the underlying echarts widget.
     * Please refer to the corresponding echarts widget Web page for possible options.
     * For example, [this page](http://echarts.baidu.com/option.html) shows
     * how to use the "Accordion" widget and the supported options (e.g. "header").
     */
    public $clientOptions = [];

    /**
     * @var array the event handlers for the underlying echarts widget.
     * Please refer to the corresponding echarts widget Web page for possible events.
    ...
    /**
     * Registers a specific echarts widget options
     * @param string $name the name of the echarts widget
    ...
    /**
     * Registers a specific echarts widget events
     * @param string $name the name of the echarts widget
     * @param string $id the ID of the widget
     */
